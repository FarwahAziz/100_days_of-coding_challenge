...
//TASK OF DAY 2
//question 4 & 5
let famousquote = "A person who never made amistake never tried anything new";
console.log(`Elbert Einstien once said "${famousquote}"`);
let famousperson = "Elbert Einstien";
let quote = `${famousperson}said"A person who never made amistake never tried anything new"`;
console.log(quote);
//question 6
